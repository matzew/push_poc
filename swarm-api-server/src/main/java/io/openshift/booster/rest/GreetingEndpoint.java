 ...
 *
 */
package io.openshift.booster.rest;

import io.openshift.booster.util.Greeting;
...
public class GreetingEndpoint {
    ...
    public static class PushnotificationEndpoint {
        ...
        private final Logger logger = LoggerFactory.getLogger(PushnotificationEndpoint.class);
